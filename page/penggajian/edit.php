...
$data = $koneksi->query("SELECT * FROM penggajian WHERE id_penggajian = '$id'")->fetch_array();
// var_dump($data);
?>

<body>
    <h2 style="margin-top: 10px; margin-bottom: 20px; margin-left: 510px; text-align: center:">Edit Data Penggajian</h2>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="row mb-3">
                            ...
                            <label class="col-1" style="color: white;">:</label>
                                <div class="col-8">
                                    <input name="id_penggajian" class="form-control" type="number" placeholder="Masukkan ID!" value="<?= $data['id_penggajian']?>" readonly>
                                </div>
                        </div>
                        <div class="row mb-3">
                        ...
                        <div class="row mb-3">
                            ...
                            <label class="col-1" style="color: white;">:</label>
                                <div class="col-8">
                                    <input name="gaji_bayar" class="form-control" type="text" placeholder="Masukan gaji_bayar!">
                                </div>
                        </div>
